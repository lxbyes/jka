...
@EnableJpaRepositories(basePackages = "me.leckie.jka.multidatasource.repository.transfer", entityManagerFactoryRef = "transferEntityManagerFactory", transactionManagerRef = "transferTransactionManager")
public class TransferDataSourceConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean transferEntityManagerFactory(EntityManagerFactoryBuilder builder) {
    return builder
        ...
        .packages("me.leckie.jka.multidatasource.domain.dataobject.transfer") //设置实体类所在位置
