...
@EnableJpaRepositories(basePackages = "me.leckie.jka.atomikos.repository.account", entityManagerFactoryRef = "accountEntityManagerFactory", transactionManagerRef = "accountTransactionManager")
public class AccountDataSourceConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean accountEntityManagerFactory(EntityManagerFactoryBuilder builder) {
    return builder
        ...
        .packages("me.leckie.jka.atomikos.domain.dataobject.account") //设置实体类所在位置
